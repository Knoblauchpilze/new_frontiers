...
namespace new_frontiers {
  ...
  class BlockMenu: public Menu {
    ...
    private:
      ...
      /**
       * @brief - The properties of the block associated to this
       *          menu. It is a polymorphic pointer to the actual
       *          derived block associated to this menu.
       *          Any action will be associated with this block.
       */
